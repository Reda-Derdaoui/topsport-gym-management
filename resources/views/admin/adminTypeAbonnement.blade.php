                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-5  max-lg:gap-4 max-md:grid-cols-1  max-md:gap-4">
                        ...
                        <div>
                            ...
                            <label for="libelle" class="block text-sm font-medium text-[#F8FAFC] max-md:text-xs">
                                Nom
                            </label>

                            <input id="libelle" type="text" name="libelle" required autocomplete="family-name"
                                value="{{ old('libelle') }}"
