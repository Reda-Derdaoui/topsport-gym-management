        ...
        <aside class="w-60 shrink-0 fixed left-0 top-0 z-50
            ...
            <div class="flex flex-col gap-4 h-full w-full
                ...
                <x-admin.admin-dashboard-links-layout href="dashboard" icon="dashboard.svg"
                    :activite="request()->is('admin/dashboard')">
                ...
                <x-admin.admin-dashboard-links-layout href="adherents" icon="person.svg"
                    :activite="request()->is('admin/adherents')">
                ...
                {{-- Responsables --}}
                <x-admin.admin-dashboard-links-layout href="responsables" icon="responsable.svg"
                    :activite="request()->is('admin/responsables')">
                ...
                {{-- Entraineurs --}}
                <x-admin.admin-dashboard-links-layout href="entraineurs" icon="coach.svg"
                    :activite="request()->is('admin/entraineurs')">
                ...
                {{-- Activities --}}
                <x-admin.admin-dashboard-links-layout href="activities" icon="karate.svg"
                    :activite="request()->is('admin/activities')">
